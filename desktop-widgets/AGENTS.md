...
Before implementing any feature, always reference `@.context/effect/` to understand Effect conventions, patterns, and best practices. Follow Effect-TS idioms consistently throughout the codebase.
